...
(gen-f90-cint "cint_gen_intor1.f90" "cint_gen_intor1"
  ;'("int1e_ovlp"                ( \| ))
  ;'("int1e_nuc"                 ( \| nuc \| ))
  '("int1e_kin"                 (.5 \| p dot p))
...
(gen-f90-cint "cint_gen_intor2.f90" "cint_gen_intor2"
  ;'("int2e"                     ( \, \| \, ))
  '("int2e_ig1"                 (#C(0 1) g \, \| \, ))
  '("int2e_gg1"                 (g g \, \| \, ))
  '("int2e_g1g2"                (-1 g \, \| g \, ))
...
(gen-f90-cint "cint_gen_intor3.f90" "cint_gen_intor3"
  '("int1e_sigma"               ( \| sigma ))
...
(gen-f90-cint "cint_gen_intor4.f90" "cint_gen_intor4"
...
(gen-f90-cint "cint_gen_dkb.f90" "cint_gen_dkb"
  ; for DKB
...
(gen-f90-cint "cint_gen_grad1.f90" "cint_gen_grad1"
  '("int1e_ipovlp"              (nabla \|))
  '("int1e_ovlpip"              (\| nabla))
...
(gen-f90-cint "cint_gen_grad2.f90" "cint_gen_grad2"
  '("int2e_ip1"                 (nabla \, \| r12 \| \,))
  '("int2e_ip2"                 ( \, \| nabla \,))
...
(gen-f90-cint "cint_gen_gaunt1.f90" "cint_gen_gaunt1"
...
(gen-f90-cint "cint_gen_breit1.f90" "cint_gen_breit1"
...
(gen-f90-cint "cint_gen_hess.f90" "cint_gen_hess"
...
(gen-f90-cint "cint_gen_int3c2e.f90" "cint_gen_int3c2e"
  '("int3c2e_ip1"               (nabla \, \| ))
  '("int3c2e_ip2"               ( \, \| nabla))
...
;
  ...
  '("int2c2e_ipip2"             ( \| r12 \| nabla nabla))
)

(gen-f90-cint "cint_gen_int3c1e.f90" "cint_gen_int3c1e"
  '("int3c1e_p2"                ( \, \, p dot p))
  '("int3c1e_iprinv"            ( p \, \| rinv \| ))
  '("int3c1e_ip1"               ( nabla \, \,))
  ;; the four second-derivative families upstream added in #129
...
(gen-f90-cint "cint_gen_deriv3.f90" "cint_gen_deriv3"
...
(gen-f90-cint "cint_gen_deriv4.f90" "cint_gen_deriv4"
...
(gen-f90-cint "cint_gen_int1e_grids1.f90" "cint_gen_int1e_grids1"
...
(gen-f90-cint "cint_gen_lresc.f90" "cint_gen_lresc"
...
;; The "based on" families.  cint1e_a.c and cint3c1e_a.c are hand-written in
;; the C -- their descriptions live in comments rather than in auto_intor.cl --
;; because the generator computes the whole 3^n tensor and then takes its
;; trace, where the hand-written version evaluates only the three diagonal
;; terms.  The arithmetic is the same and in the same order, so the generated
;; form is bit-identical; it just does more work to get there.  Generating them
;; keeps one description list rather than two, and the C is free to stay as it
;; is.
(gen-f90-cint "cint_gen_a.f90" "cint_gen_a"
  '("int1e_r2_origi"        ( r dot r \| ))
  '("int1e_r4_origi"        ( r dot r r dot r \| ))
  '("int1e_r2_origi_ip2"    ( r dot r \| nabla ))
  '("int1e_r4_origi_ip2"    ( r dot r r dot r \| nabla ))
