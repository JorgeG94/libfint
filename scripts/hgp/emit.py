...
def emit_kernel(pl):
    ...
    o.append(f"      real(dp) :: cb({NT}, {pl.ntb}*ncb)")
    ...
    o.append("         ! THE CONTRACTION IS STAGED, and that is not a detail: done")
    o.append("         ! flat -- every (bra column, ket column) pair touched at every")
    o.append("         ! primitive quartet -- it costs the product of the two")
    o.append("         ! contraction counts per quartet, which on a generally")
    o.append("         ! contracted shell (cc-pVDZ carbon s: 9 primitives, 3")
    o.append("         ! contractions) is 81 accumulations of the whole target vector")
    o.append("         ! 6561 times over.  Summing the bra columns first and folding")
    o.append("         ! in the ket ones once per ket primitive turns a product into")
    o.append("         ! a sum, which is what libcint's prim_to_ctr staging does.")
    o.append("         cb = 0.0_dp")
    o.append("         hit = .false.")
    ...
    o.append(f"               cb(1:{NT},bc) = cb(1:{NT},bc) + kab(bc,bq)*tv(1:{NT})")
    o.append("            end do")
    o.append("         end do")
    ...
    o.append(f"            do bc = 1, {pl.ntb}*ncb")
    o.append(f"               c(1:{NT},bc,kc) = c(1:{NT},bc,kc) + kcd(kc,kq)*cb(1:{NT},bc)")
    o.append("            end do")
    o.append("         end do")
    o.append("      end do")
    o.append("      res = 0.0_dp")
