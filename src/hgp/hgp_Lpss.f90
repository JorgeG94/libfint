...
contains
   ! (Lp|ss)  Lpss: vrr=15 carried=10 hrr=25 in 2 block(s) comps=12
   subroutine hgp_Lpss(nbra, ncb, bp, kab, nket, nck, kp, kcd, ab, cd, cutoff, res, any)
   ...
   end subroutine hgp_Lpss
end module hgp_Lpss_m
