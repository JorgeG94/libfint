...
! the operators follow so array expressions keep working. That is legal
! because the C underneath has no state -- the interfaces are declared pure.
!
module cint_quad
   ...
   interface
      pure subroutine mqq_add(a, b, r) bind(c, name="mqq_add")
         import quad
         type(quad), intent(in) :: a, b
         type(quad), intent(out) :: r
      end subroutine mqq_add
      pure subroutine mqq_sub(a, b, r) bind(c, name="mqq_sub")
         import quad
         type(quad), intent(in) :: a, b
         type(quad), intent(out) :: r
      end subroutine mqq_sub
      pure subroutine mqq_mul(a, b, r) bind(c, name="mqq_mul")
         import quad
         type(quad), intent(in) :: a, b
         type(quad), intent(out) :: r
      end subroutine mqq_mul
      pure subroutine mqq_div(a, b, r) bind(c, name="mqq_div")
         import quad
         type(quad), intent(in) :: a, b
         type(quad), intent(out) :: r
      end subroutine mqq_div
      pure subroutine mqq_neg(a, r) bind(c, name="mqq_neg")
         import quad
         type(quad), intent(in) :: a
         type(quad), intent(out) :: r
      end subroutine mqq_neg
      pure subroutine mqq_abs(a, r) bind(c, name="mqq_abs")
         import quad
         type(quad), intent(in) :: a
         type(quad), intent(out) :: r
      end subroutine mqq_abs
      pure subroutine mqq_sqrt(a, r) bind(c, name="mqq_sqrt")
         import quad
         type(quad), intent(in) :: a
         type(quad), intent(out) :: r
      end subroutine mqq_sqrt
      pure subroutine mqq_exp(a, r) bind(c, name="mqq_exp")
         import quad
         type(quad), intent(in) :: a
         type(quad), intent(out) :: r
      end subroutine mqq_exp
      pure subroutine mqq_erf(a, r) bind(c, name="mqq_erf")
         import quad
         type(quad), intent(in) :: a
         type(quad), intent(out) :: r
      end subroutine mqq_erf
      pure subroutine mqq_erfc(a, r) bind(c, name="mqq_erfc")
         import quad
         type(quad), intent(in) :: a
         type(quad), intent(out) :: r
      end subroutine mqq_erfc
      pure subroutine mqq_from_3d(a1, a2, a3, r) bind(c, name="mqq_from_3d")
         import quad, c_double
         real(c_double), value :: a1, a2, a3
         type(quad), intent(out) :: r
      end subroutine mqq_from_3d
      pure subroutine mqq_from_d(d, r) bind(c, name="mqq_from_d")
         import quad, c_double
         real(c_double), value :: d
         type(quad), intent(out) :: r
      end subroutine mqq_from_d
      pure subroutine mqq_from_i(n, r) bind(c, name="mqq_from_i")
         import quad, c_int
         integer(c_int), value :: n
         type(quad), intent(out) :: r
      end subroutine mqq_from_i
      pure function mqq_to_d(a) bind(c, name="mqq_to_d") result(v)
         import quad, c_double
         type(quad), intent(in) :: a
         real(c_double) :: v
      end function mqq_to_d
      pure function mqq_cmp(a, b) bind(c, name="mqq_cmp") result(v)
         import quad, c_int
         type(quad), intent(in) :: a, b
         integer(c_int) :: v
...
contains
   ...
   elemental type(quad) function q_add(a, b) result(r)
      type(quad), intent(in) :: a, b
      call mqq_add(a, b, r)
   end function q_add

   elemental type(quad) function q_sub(a, b) result(r)
      type(quad), intent(in) :: a, b
      call mqq_sub(a, b, r)
   end function q_sub

   elemental type(quad) function q_mul(a, b) result(r)
      type(quad), intent(in) :: a, b
      call mqq_mul(a, b, r)
   end function q_mul

   elemental type(quad) function q_div(a, b) result(r)
      type(quad), intent(in) :: a, b
      call mqq_div(a, b, r)
   end function q_div

   elemental type(quad) function q_neg(a) result(r)
      type(quad), intent(in) :: a
      call mqq_neg(a, r)
   end function q_neg

   elemental type(quad) function q_abs(a) result(r)
      type(quad), intent(in) :: a
      call mqq_abs(a, r)
   end function q_abs

   elemental type(quad) function q_sqrt(a) result(r)
      type(quad), intent(in) :: a
      call mqq_sqrt(a, r)
   end function q_sqrt

   elemental type(quad) function q_exp(a) result(r)
      type(quad), intent(in) :: a
      call mqq_exp(a, r)
   end function q_exp

   elemental type(quad) function q_erf(a) result(r)
      type(quad), intent(in) :: a
      call mqq_erf(a, r)
   end function q_erf

   elemental type(quad) function q_erfc(a) result(r)
      type(quad), intent(in) :: a
      call mqq_erfc(a, r)
   end function q_erfc

   elemental type(quad) function q_from_r(x) result(r)
      real(dp), intent(in) :: x
      call mqq_from_d(real(x, c_double), r)
   end function q_from_r

   elemental type(quad) function q_from_i(n) result(r)
      integer, intent(in) :: n
      call mqq_from_i(int(n, c_int), r)
   end function q_from_i

   elemental type(quad) function quad_from3(a1, a2, a3) result(r)
   ...
   elemental real(dp) function quad_to_dp(a) result(v)
      type(quad), intent(in) :: a
      v = real(mqq_to_d(a), dp)
   end function quad_to_dp

   elemental subroutine q_assign_r(out, in)
      type(quad), intent(out) :: out
      real(dp), intent(in) :: in
      out = q_from_r(in)
   end subroutine q_assign_r

   elemental type(quad) function q_pow_i(a, n) result(r)
      type(quad), intent(in) :: a
      integer, intent(in) :: n
      type(quad) :: base
      integer :: k
   ...
   elemental type(quad) function q_max(a, b) result(r)
      type(quad), intent(in) :: a, b
      r = a
      if (mqq_cmp(b, a) > 0) r = b
   end function q_max

   elemental type(quad) function q_min(a, b) result(r)
      type(quad), intent(in) :: a, b
      r = a
      if (mqq_cmp(b, a) < 0) r = b
   end function q_min

   elemental type(quad) function q_add_r(a, b) result(r)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      r = q_add(a, q_from_r(b))
   end function q_add_r

   elemental type(quad) function q_r_add(a, b) result(r)
      real(dp), intent(in) :: a
      type(quad), intent(in) :: b
      r = q_add(q_from_r(a), b)
   end function q_r_add

   elemental type(quad) function q_sub_r(a, b) result(r)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      r = q_sub(a, q_from_r(b))
   end function q_sub_r

   elemental type(quad) function q_r_sub(a, b) result(r)
      real(dp), intent(in) :: a
      type(quad), intent(in) :: b
      r = q_sub(q_from_r(a), b)
   end function q_r_sub

   elemental type(quad) function q_mul_r(a, b) result(r)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      r = q_mul(a, q_from_r(b))
   end function q_mul_r

   elemental type(quad) function q_r_mul(a, b) result(r)
      real(dp), intent(in) :: a
      type(quad), intent(in) :: b
      r = q_mul(q_from_r(a), b)
   end function q_r_mul

   elemental type(quad) function q_div_r(a, b) result(r)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      r = q_div(a, q_from_r(b))
   end function q_div_r

   elemental type(quad) function q_r_div(a, b) result(r)
      real(dp), intent(in) :: a
      type(quad), intent(in) :: b
      r = q_div(q_from_r(a), b)
   end function q_r_div

   elemental logical function q_lt(a, b) result(v)
      type(quad), intent(in) :: a, b
      v = mqq_cmp(a, b) < 0
   end function q_lt

   elemental logical function q_lt_r(a, b) result(v)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      v = q_lt(a, q_from_r(b))
   end function q_lt_r

   elemental logical function q_gt(a, b) result(v)
      type(quad), intent(in) :: a, b
      v = mqq_cmp(a, b) > 0
   end function q_gt

   elemental logical function q_gt_r(a, b) result(v)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      v = q_gt(a, q_from_r(b))
   end function q_gt_r

   elemental logical function q_le(a, b) result(v)
      type(quad), intent(in) :: a, b
      v = mqq_cmp(a, b) <= 0
   end function q_le

   elemental logical function q_le_r(a, b) result(v)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      v = q_le(a, q_from_r(b))
   end function q_le_r

   elemental logical function q_ge(a, b) result(v)
      type(quad), intent(in) :: a, b
      v = mqq_cmp(a, b) >= 0
   end function q_ge

   elemental logical function q_ge_r(a, b) result(v)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      v = q_ge(a, q_from_r(b))
   end function q_ge_r

   elemental logical function q_eq(a, b) result(v)
      type(quad), intent(in) :: a, b
      v = mqq_cmp(a, b) == 0
   end function q_eq

   elemental logical function q_eq_r(a, b) result(v)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      v = q_eq(a, q_from_r(b))
   end function q_eq_r

   elemental type(quad) function q_max_r(a, b) result(r)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
      r = q_max(a, q_from_r(b))
   end function q_max_r

   elemental type(quad) function q_min_r(a, b) result(r)
      type(quad), intent(in) :: a
      real(dp), intent(in) :: b
